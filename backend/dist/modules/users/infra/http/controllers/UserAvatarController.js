...
var UserAvatarController = /** @class */ (function () {
    ...
    UserAvatarController.prototype.uptade = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var updateUserAvataer, user;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        updateUserAvataer = tsyringe_1.container.resolve(UpdateUserAvatarService_1.default);
                        return [4 /*yield*/, updateUserAvataer.execute({
